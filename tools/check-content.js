...
import {STRATAGEMS} from '../src/content/stratagems.js';
import {LEADGATES} from '../src/content/lead-unlocks.js';
...
check('stratagems', STRATAGEMS, data.stratagems);
check('leadUnlocks', LEADGATES, data.leadUnlocks);
