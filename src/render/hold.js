...
const TICKERPOOL = [
  ...
  'proto frames now available for launch',
  // A pilot calling out on the net. The Zero Frame is not in the pool — the
  // ticker is the one place the setting can be wider than the card list.
  'heero, zero frame — launching',
];
