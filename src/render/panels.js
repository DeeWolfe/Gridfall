...
function achievementList() {
  ...
  return [
    ...
    {n: 'Deep Water Mark', d: 'Reach the fourth layer of a Deep Descent.', have: active.bests.run || 0, need: 4},
    {n: 'Down and Out', d: 'Put down the target at the end of a Deep Descent.', have: active.bests.runsDone || 0, need: 1},
...
function recordPanel() {
  ...
  return bar + `<div class="sect">Field record</div><div class="rows">${fieldRecord}</div>
   ...
   <div class="row"><span>Deep Descent — deepest layer</span><span class="r hot">${active.bests.run || 0}</span></div>
   <div class="row"><span>Deep Descents completed</span><span class="r hot">${active.bests.runsDone || 0}</span></div>
