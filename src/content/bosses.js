...
export const BOSSDEF = {
  ...
  brood: {
    ...
    debrief: {
      ...
      beats: [
        {
          say: ["The tunnels are quiet, Commander. For the first time in months, the seismic net reads nothing at all.", "Analysis of the remains confirms what the yards suggested: the same absorption. It was digging for the crystal seams — feeding, multiplying — and eating the mining grid as it went: machines, alloys, the tunnels themselves, made into more of itself."],
