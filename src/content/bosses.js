  ...
  prism: {
    ...
    brief: {
      ...
      beats: [
        ...
        {
          say: ["We had a Proto Frame connected to power batteries and hit it with a full blast. We lost the whole contingent of UPE forces as a result.", "But it gave us results. It shatters. Four fragments, separate lanes, each still reflecting — and each growing back every turn. There is a ceiling to the growth, but a slow gun will not beat it there. When it breaks, Central believes killing the pieces fast and all at once will do it.", "Watch the reflection, Commander. For once, your face isn't the most dangerous thing here."],
