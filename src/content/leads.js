...
export const LEADS = {
  ...
  salvagerights: {
    ...
    passive: {
      n: "The Code",
      d: "Your destroyed Frame returns to hand with its gear and redeploys 2 DP cheaper. Every wreck, never more than 2.",
    },
  ...
  masterchief: {
    ...
    passive: {n: "Spartan Company", d: "Fireteam cards cost 1 less deploy point, minimum 1."},
    con: {n: "No Frame", d: "You cannot field a Proto Frame."},
  },
};
