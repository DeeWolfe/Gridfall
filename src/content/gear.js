...
// The 27 gear pieces, one slot per card, bought with credits.
...
export const GEAR = {
  ...
  railcannon: {
    n: "Hyper Rail Cannon",
    cost: 560,
    d: "Anti-armour. One hostile down the lane, and armour floors do not apply — what it hits, it hits for all of it.",
    frame: "whitedevil",
    role: "offense",
    tg: "first",
    dmg: 9,
