...
// The 26 gear pieces, one slot per card, bought with credits.
...
export const GEAR = {
  ...
  beamrifle: {
    n: "Beam Rifle",
    cost: 440,
    d: "Replaces the White Devil's blade. One hostile down the lane, hit very hard.",
    frame: "whitedevil",
    role: "offense",
    tg: "first",
    dmg: 8,
  ...
  beamsaber: {
    n: "Beam Saber",
    cost: 480,
    d: "Replaces the White Devil's blade. Brutal at contact, and it answers anything that strikes the frame.",
    frame: "whitedevil",
    role: "offense",
    tg: "adj",
    dmg: 10,
