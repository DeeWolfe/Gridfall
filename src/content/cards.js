...
// The 66 deployable cards, keyed by card id.
...
export const POOL = {
  ...
  pilot: {
    ...
    dmg: 0,
    pilot: 1,
    d: "Carries no weapon and cannot hold a cell. Deploy one, keep it alive, and a Frame can land on it — that is the whole job.",
  },
  whitedevil: {
    n: "White Devil",
    t: "special",
    ...
    blocker: 1,
    single: 1,
    d: "The defensive frame. A regenerating shield and a service blade it barely needs. Bare it is a wall that hits back; kitted it is whatever you decided before the drop.",
  },
  sevenblades: {
    n: "Seven Blades",
    t: "special",
    ...
    blocker: 1,
    single: 1,
    d: "The melee frame. An arm-mounted blade and nothing else — it does not want range, it wants to be standing where you put it.",
  },
  heavyarms: {
    n: "Heavy Arms",
    t: "special",
    ...
    blocker: 1,
    single: 1,
    d: "The artillery frame. Anchored, heaviest hull on the field, and a ballistic gatling that does not care what it is pointed at.",
  },
};
